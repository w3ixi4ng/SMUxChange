// components/SpecificSchool/AccomodationSkeleton.tsx
function AccomodationSkeleton({ count = 4 }: { count?: number }) {
  return (
    <>
      {Array.from({ length: count }).map((_, i) => (
        <div
          key={i}
          className="shrink-0 w-72 snap-start bg-white border border-[#102b72]/20 rounded-xl flex flex-col"
        >
          <span
          ...
          <div className="p-3">
            <div className="placeholder-glow mb-2">
              <span className="placeholder col-7 d-block" style={{ height: 18 }} />
            </div>
            <div className="placeholder-glow mb-2">
...
export default AccomodationSkeleton;